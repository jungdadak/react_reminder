...
import { addDataa } from '../models/DataSlice';
...
export default function Detailpage({ shoes }) {
  ...
  console.log(shoe.id);
  useEffect(() => {
    let now = localStorage.getItem('watched');
    let temp1 = JSON.parse(now);
    temp1.push(shoe.id);
    temp1 = new Set(temp1);
    temp1 = Array.from(temp1);
    localStorage.setItem('watched', JSON.stringify(temp1));
  }, []);
  console.log('로컬', localStorage.getItem('watched'));
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6 p-4">
          ...
          <button
            ...
            className="w-full bg-red-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-red-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
          >
            주문하기
          </button>
